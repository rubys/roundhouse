...
pub fn emit(app: &App) -> Vec<EmittedFile> {
    ...
    // src/lib.rs — declares the modules emitted above. Inflector is
    // the only transpiled module in Phase 2.1; later phases add
    // active_record, action_view, etc. as their files land.
