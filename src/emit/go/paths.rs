//! Output-path routing for the go emitter.
//!
//! Every emitted file in the go overlay flows through `output_path`
...
//! that previously lived inline in `go.rs`.
//!
...
/// Output destination for a file emitted by the go overlay.
