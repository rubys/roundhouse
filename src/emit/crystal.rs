...
/// expect to compile. Phase 1 scope: models only. Controllers + routes
/// are emitted as files but not required, for the same reason the Rust
/// emitter keeps controllers out of `lib.rs`: their bodies reference a
/// Rails runtime that doesn't exist yet.
