...
/// Ingest a model test file (`test/models/<name>_test.rb`). Expects a
/// single top-level class (typically inheriting from
/// `ActiveSupport::TestCase`) whose body is a sequence of
