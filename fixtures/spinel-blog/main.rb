...
# Importmap is generated by Roundhouse from real-blog's
# config/importmap.rb. The standalone spinel-blog specimen omits it
# (no importmap to ingest); the runtime helper detects that and falls
# back to a Turbo-only shape.
begin
