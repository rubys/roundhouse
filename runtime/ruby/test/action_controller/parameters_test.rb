...
# Direct unit tests for `runtime/ruby/action_controller/parameters.rb`.
# Promoted from fixtures/spinel-blog/test/runtime/parameters_test.rb;
# this version is framework-only (no blog app required). Same
# assertions cover the same behavior — string/symbol key
# normalization, key?/to_h surface, the require + permit chain
# every controller action goes through.
