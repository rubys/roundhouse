...
export class Validations {
  ...
  validates_length_of(attr_name: string, value: any, { minimum, maximum, is }: { minimum?: any, maximum?: any, is?: any } = {}): void {
  ...
  validates_numericality_of(attr_name: string, value: any, { greater_than, less_than, only_integer }: { greater_than?: any, less_than?: any, only_integer?: boolean } = {}): void {
  ...
  validates_inclusion_of(attr_name: string, value: any, { within }: { within: string[] }): void {
    if (within.includes(value)) return;
